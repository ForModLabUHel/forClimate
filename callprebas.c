...
// a global variable that defines when the current climate is (re)sampled
// 1 = sample now
// 0 = keep the sample
static int intChangeCurrentclimate = 1;

void ChangeCurrentClimate()
{
  intChangeCurrentclimate = 1;
}

void UseCurrentClimate()
{
